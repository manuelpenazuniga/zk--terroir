...
- **No uses:** GLM-5.1 (dominado por 5.2). **Kimi K2.7 Code → VETADO por costo (ZK-Terroir, 2026-07-01):** tier T2 escaso (~1.350 req/5h, $0.95/$4.00) y sin benchmark independiente; su rol lo cubre **DeepSeek V4 Pro**. (Vetados totales por costo: Qwen 3.7 Max · GLM-5.2 · Kimi K2.7 Code — ver `model-routing.md`.)
...
- **Banca:** M2.7 (solo latencia/overflow) · GLM-5.1 (dominado) · **K2.7 Code, GLM-5.2, Qwen 3.7 Max = VETADOS por costo** (ZK-Terroir)
